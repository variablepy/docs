...
| `ReCaptchaV3Token` | Yes | reCAPTCHA v3 |
| `ReCaptchaV3TokenProxyLess` | No | reCAPTCHA v3 (no proxy) |
| `ReCaptchaV3EnterpriseToken` | Yes | reCAPTCHA v3 Enterprise |
| `ReCaptchaV3EnterpriseTokenProxyLess` | No | reCAPTCHA v3 Enterprise (no proxy) |
