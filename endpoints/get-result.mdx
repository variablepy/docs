...
The `token` field contains the solved captcha token or cookie value depending on the task type.
...
Results are stored for 5 minutes after solving. After that, they are cleaned up and cannot be retrieved.
